...
class SequenceDistanceClustersPerGroup():
    ...
    def __init__(self,
        ...
        self.cluster_algo_name = return_value_if_not_none(self.cluster_function,
                                                          self.cluster_function.__name__,
                                                          None,
                                                          True,
        ...
        self.dimensionality_reduction_algo_name = return_value_if_not_none(self.dimensionality_reduction_function,
                                                                           self.dimensionality_reduction_function.__name__,
                                                                           None,
                                                                           False,
                                                                           None)

        self.cluster_validation_algo_names = []
        self.cluster_validation_algo_names.extend(return_value_if_not_none(self.cluster_validation_functions,
                                                                           [i.__name__ for i in self.cluster_validation_functions],
                                                                           [],
                                                                           False,
                                                                           None))

        self.cluster_validation_algo_names.extend(return_value_if_not_none(self.cluster_validation_attributes,
                                                                           list(self.cluster_validation_attributes),
                                                                           [],
                                                                           False,
                                                                           None))
        ...
        self.cluster_para_fields = return_value_if_not_none(self.cluster_param_grid_generator,
                                                            list(self.cluster_param_grid_generator(None).return_params()),
                                                            None,
                                                            True,
                                                            CLUSTERING_PARAMETER_TUNING_ERROR_NO_CLUSTER_PARAM_GRID_NAME_STR)
        self.dim_reduct_para_fields = return_value_if_not_none(self.dimensionality_reduction_param_grid_generator,
                                                               list(self.dimensionality_reduction_param_grid_generator(None).return_params()),
                                                               None,
                                                               False,
                                                               None)
