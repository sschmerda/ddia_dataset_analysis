...
class SequenceDistanceAnalytics:
    ...
    def plot_sequence_distance_per_group(self):
        ...
        data_name_list = [self.seq_dist_data_name, 
                          self.unique_seq_dist_data_name]
        caption_list = [f'Base: All {USER_FIELD_NAME_STR}-{SEQUENCE_STR} Combinations', 
                        f'Base: All Unique-{SEQUENCE_STR} Combinations']
        
        # use generator to save memory when reading in sequence distance results dataframes
        def _return_generator(data_name_list, caption_list):
        ...
        for x_var in SequenceDistanceAnalytics.seq_distance_fields:
            for data, caption in _return_generator(data_name_list, caption_list):
                print('-'*100)
                ...
                if x_var == LEARNING_ACTIVITY_NORMALIZED_SEQUENCE_DISTANCE_NAME_STR:
                ...
                g=sns.catplot(data=data,
                            ...
                            #   col_wrap=n_cols, 
                              ...
                              showmeans=True,
                              meanprops=marker_config,
                              palette=return_color_palette(self._n_groups),
        ...
        avg_per_group_data_list = [self.avg_dist_length_per_all_seq_combinations_per_group_df, 
                                   self.avg_dist_length_per_unique_seq_combinations_per_group_df] 
