...
# annotations
EQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_TEXT_FONTSIZE = 20
EQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_TEXTBOX_LINEWIDTH = 2
EQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_TEXTBOX_STYLE = 'square'
EQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_ARROW_LINEWIDTH = 2
# brackets + text
# conf int mean
