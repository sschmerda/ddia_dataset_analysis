...
SEQUENCE_STATISTICS_FIELDS_TO_PLOT_LIST = [SequenceStatisticsPlotFields.SEQUENCE_LENGTH,
                                           ...
                                           SequenceStatisticsPlotFields.MEAN_SEQUENCE_DISTANCE_ALL_SEQUENCES,
                                           SequenceStatisticsPlotFields.MEAN_NORMALIZED_SEQUENCE_DISTANCE_ALL_SEQUENCES]
...
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_BOX_KIND = BoxKind.BOTH
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_KIND = ConfidenceIntervalKind.BOTH
...
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_BOX_EDGECOLOR = 'black'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_BOX_EDGE_LINEWIDTH = SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_IQR_BOX_EDGE_LINEWIDTH
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_BOX_ALPHA = 0.6
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_UPPER_BOX_FACECOLOR = 'red'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_LOWER_BOX_FACECOLOR = 'cornflowerblue'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_BOX_SCATTER_COLOR = 'white'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_BOX_SCATTER_EDGECOLOR = 'black'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_BOX_SCATTER_LINEWIDTH = 0.6
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_DUAL_BOX_SCATTER_SIZE = 8
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_SINGLE_BOX_SCATTER_SIZE = 14
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_DUAL_UPPER_BOX_SCATTER_MARKER = 'o'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_DUAL_LOWER_BOX_SCATTER_MARKER = 's'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_SINGLE_BOX_SCATTER_MARKER = 'o'
...
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_DATA_RANGE_LIMITS_RAW = (1, np.inf)
