...
# ridgeplot config
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_Y_AXIS_TICK_SHIFT_INCREMENT = 0.9
...
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_INCLUDE_KDE_BOTTOM_LINE = True
...
# ridgeplot conf int
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_OUTER_LINEPLOT_COLOR = 'black'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_OUTER_LINEPLOT_LINEWIDTH = 6
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_INNER_LINEPLOT_COLOR = 'red'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_INNER_LINEPLOT_LINEWIDTH = 4
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_SCATTER_COLOR = 'white'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_SCATTER_EDGECOLOR = 'black'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_SCATTER_LINEWIDTH = 1
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_CONF_INT_SCATTER_SIZE = 8
