...
########################################################################################################################
### plot_sequence_statistics_distribution_ridgeplot_mockup options ###
########################################################################################################################

# plot name
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_PLOT_NAME = 'sequence_statistics_distribution_ridgeplot_mockup_'

# plot decorator
def sequence_statistics_distribution_ridgeplot_mockup_decorator(func):
    """A decorator to apply temporary Seaborn settings."""
...
# data
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_DATA_MU = 0
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_DATA_SIMGA = 1
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_DATA_RANGE_LIMITS = (-4, 4)
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_DATA_N_POINTS = 1_000
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_DATA_RANGE_LOWER_QUANTILE = 0.001
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_DATA_RANGE_UPPER_QUANTILE = 0.999
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_DATA_CI_MEAN_RATIO_OF_BOX_WIDTH = 0.45
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_DATA_CI_MEDIAN_RATIO_OF_BOX_WIDTH = 0.6

# annotations
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_TEXT_FONTSIZE = 20
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_TEXTBOX_LINEWIDTH = 2
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_TEXTBOX_STYLE = 'square'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_ARROW_LINEWIDTH = 2
# brackets + text
# conf int mean
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_CONF_INT_MEAN_TEXT_STR = 'Conf Int Mean'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_CONF_INT_MEAN_Y_OFFSET_FROM_BOX = 0.01
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_CONF_INT_MEAN_BRACKET_HEIGTH = 0.02
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_CONF_INT_MEAN_TEXT_Y_OFFSET_FROM_BRACKET = 0.03
# conf int median
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_CONF_INT_MEDIAN_TEXT_STR = 'Conf Int Median'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_CONF_INT_MEDIAN_Y_OFFSET_FROM_BOX = 0.01
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_CONF_INT_MEDIAN_BRACKET_HEIGTH = 0.02
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_CONF_INT_MEDIAN_TEXT_Y_OFFSET_FROM_BRACKET = 0.03
# IQR
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_IQR_TEXT_STR = 'IQR'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_IQR_Y_OFFSET_FROM_BOX = 0.09
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_IQR_BRACKET_HEIGTH = 0.02
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_IQR_TEXT_Y_OFFSET_FROM_BRACKET = 0.03
# range
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_RANGE_TEXT_STR = 'Range'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_RANGE_Y_OFFSET_FROM_BOX = 0.22
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_RANGE_BRACKET_HEIGTH = 0.02
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_RANGE_TEXT_Y_OFFSET_FROM_BRACKET = 0.03
# arrows
# single arrow
# mean
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_SINGLE_CONF_INT_MEAN_MARKER_TEXT_STR = 'Mean'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_SINGLE_CONF_INT_MEAN_MARKER_TEXT_POSITION_PROPORTION = (0.33, 0.75)
# median
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_SINGLE_CONF_INT_MEDIAN_MARKER_TEXT_STR = 'Median'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_SINGLE_CONF_INT_MEDIAN_MARKER_TEXT_POSITION_PROPORTION = (0.33, 0.75)
# kde 
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_KDE_ARROW_TEXT_STR = 'Kernel Density Estimate'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_KDE_ARROW_TEXT_POSITION_PROPORTION = (0.8, 0.80)
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_KDE_ARROW_POSITION_QUANTILE = 0.64
# dual arrow
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_DUAL_CONF_INT_UPPER_MARKER_TEXT_STR = 'Mean'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_DUAL_CONF_INT_LOWER_MARKER_TEXT_STR = 'Median'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_DUAL_CONF_INT_UPPER_MARKER_TEXT_POSITION_PROPORTION = (0.25, 0.60)
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_ANNOTATION_DUAL_CONF_INT_LOWER_MARKER_TEXT_POSITION_PROPORTION = (0.75, 0.60)

# ridgeplot range, interquartile range and conf int kind
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_CONF_INT_KIND = ConfidenceIntervalKind.BOTH

# ridgeplot lines
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_OUTER_LINEPLOT_COLOR = 'white'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_OUTER_LINEPLOT_LINEWIDTH = 10
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_OUTER_LINEPLOT_ALPHA = 0.6
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_INNER_LINEPLOT_COLOR = 'black'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_INNER_LINEPLOT_LINEWIDTH = 2
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_INNER_LINEPLOT_ALPHA = 0.8
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_INCLUDE_KDE_BOTTOM_LINE = False
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_BOTTOM_LINEPLOT_COLOR = 'black'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_BOTTOM_LINEPLOT_LINEWIDTH = 1
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_BOTTOM_LINEPLOT_ALPHA = 0.8
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_FILL_COLOR = 'blue'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_FILL_ALPHA = 0.2

# ridgeplot range and interquartile range box
# iqr
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_IQR_BOX_EDGECOLOR = 'black'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_IQR_BOX_EDGE_LINEWIDTH = 2
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_IQR_BOX_HEIGHT_IN_LINEWIDTH = 16 * 8
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_IQR_BOX_FACECOLOR = '0.9'
# range
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_RANGE_BOX_EDGECOLOR = 'black'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_RANGE_BOX_EDGE_LINEWIDTH = 2
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_RANGE_BOX_HEIGHT_IN_LINEWIDTH = SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_IQR_BOX_HEIGHT_IN_LINEWIDTH / 6 
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_RANGE_BOX_FACECOLOR = '0.9'

# ridgeplot conf int box
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_CONF_INT_BOX_EDGECOLOR = 'black'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_CONF_INT_BOX_EDGE_LINEWIDTH = SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_IQR_BOX_EDGE_LINEWIDTH
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_CONF_INT_BOX_ALPHA = 0.6
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_CONF_INT_UPPER_BOX_FACECOLOR = 'red'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_CONF_INT_LOWER_BOX_FACECOLOR = 'cornflowerblue'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_CONF_INT_BOX_SCATTER_COLOR = 'white'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_CONF_INT_BOX_SCATTER_EDGECOLOR = 'black'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_CONF_INT_BOX_SCATTER_LINEWIDTH = 1.5
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_CONF_INT_DUAL_BOX_SCATTER_SIZE = 70
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_CONF_INT_SINGLE_BOX_SCATTER_SIZE = 70
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_CONF_INT_DUAL_UPPER_BOX_SCATTER_MARKER = 'o'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_CONF_INT_DUAL_LOWER_BOX_SCATTER_MARKER = 's'
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_CONF_INT_SINGLE_BOX_SCATTER_MARKER = 'o'

# spines
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_SHOW_TOP = False
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_SHOW_BOTTOM = False
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_SHOW_LEFT = False
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_SHOW_RIGHT = False
# axes
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_GRID_LINE_AXIS = Axes.X_AXIS
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_X_AXIS_MARGIN = 0
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_Y_AXIS_MARGIN = 0.1
# axes labels
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_PLOT_X_AXIS_LABEL = False
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_PLOT_Y_AXIS_LABEL = False
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_X_AXIS_LABEL = None
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_Y_AXIS_LABEL = GROUP_FIELD_NAME_STR
# ticks
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_PLOT_X_AXIS_TICKS = False
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_PLOT_Y_AXIS_TICKS = False
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_PLOT_X_AXIS_TICK_LABELS = False
SEQUENCE_STATISTICS_DISTRIBUTION_RIDGEPLOT_MOCKUP_PLOT_Y_AXIS_TICK_LABELS = False
...
# annotations for facets with all groups filltered out
OMNIBUS_TEST_RESULT_MEASURE_ASSOCIATION_FILTERED_OUT_GROUPS_ANNOTATION_TEXT_POSITION = (0.5, 0.5)
OMNIBUS_TEST_RESULT_MEASURE_ASSOCIATION_FILTERED_OUT_GROUPS_ANNOTATION_TEXT_FONTSIZE = 18
OMNIBUS_TEST_RESULT_MEASURE_ASSOCIATION_FILTERED_OUT_GROUPS_ANNOTATION_TEXTBOX_LINEWIDTH = 2
OMNIBUS_TEST_RESULT_MEASURE_ASSOCIATION_FILTERED_OUT_GROUPS_ANNOTATION_TEXTBOX_STYLE = 'square'